package com.pear.facedetector.custom;
...
public abstract class StickerView extends FrameLayout {
    ...
    public final static int BUTTON_SIZE_DP = 30;
    ...
    private void init(Context context, Sendata isEdit) {
//        this.isEdit = isEdit;
        this.sendata = isEdit;
...
//        StickerView.this.setBackgroundColor(Color.BLACK);
        ...
        this.imageViewScale.setImageResource(android.R.drawable.ic_input_add);
        this.imageViewDelete.setImageResource(android.R.drawable.ic_input_add);
        this.imageViewFlip.setImageResource(android.R.drawable.ic_input_add);
...
//        this_params.gravity = Gravity.CENTER;
        ...
        this.imageViewDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (sendata != null) {
                    sendata.onCloseSticker(StickerView.this);
                    ViewGroup canvas = (ViewGroup) StickerView.this.getParent();
                    if (canvas != null && StickerView.this != null) {
                        canvas.removeView(StickerView.this);
                    }
                }
            }
        });
...
//                setEdit(true);
    ...
    public interface Sendata {
        void sendData(StickerView stickerView);

        void onCloseSticker(StickerView stickerView);
    }
...
//                        setEdit(true);
                        ...
                        //sendata.sendData(StickerView.this);
...
//                        StickerView.this.setTop(coordinateYTop);
                        ...
                        Log.e("TAG", "X " + coordinateX);
                        Log.e("TAG", "Y " + coordinateY);
...
//                        StickerView.this.setTop((int) (StickerView.this.getY() + offsetY));
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (touchStop - touchStart < 200) {
                            if (imageViewBorder.getVisibility() == VISIBLE) {
...
//            imageViewBorder.setVisibility(View.VISIBLE);
            ...
            imageViewBorder.setVisibility(GONE);
        }
    }
